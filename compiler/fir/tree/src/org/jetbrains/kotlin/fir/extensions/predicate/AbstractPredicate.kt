 ...
 *
 * [LookupPredicate] allows user to get all declarations in compiled module which matches this predicate
 * Both [LookupPredicate] and [DeclarationPredicate] allows user to check if some declaration matches the predicate
