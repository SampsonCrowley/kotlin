...
sealed class LookupPredicate : AbstractPredicate<LookupPredicate> {
    ...
    object BuilderContext : AbstractPredicate.BuilderContext<LookupPredicate>() {
        ...
        // ------------------- varargs -------------------
        override fun annotated(vararg annotations: AnnotationFqn): LookupPredicate = AnnotatedWith(annotations.toSet())
        override fun ancestorAnnotated(vararg annotations: AnnotationFqn): LookupPredicate = AncestorAnnotatedWith(annotations.toSet())
        override fun parentAnnotated(vararg annotations: AnnotationFqn): LookupPredicate = ParentAnnotatedWith(annotations.toSet())
        override fun hasAnnotated(vararg annotations: AnnotationFqn): LookupPredicate = HasAnnotatedWith(annotations.toSet())
